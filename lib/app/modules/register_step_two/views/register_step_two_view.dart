            ...
            child: Column(
              ...
              children: [
                AppbarDefault(
                  leading: Row(
                    children: [
                      IconButton(onPressed: () => Get.back(), icon: SvgPicture.asset('assets/images/icon-back.svg'))
                    ],
                  ),
                  title: Text(
                                        ...
                                        items: List.generate(controller.phonePrefixes.length, (index) {
                                          ...
                                          return DropdownMenuItem(
                                              child: Row(
                                                  ...
                                                  children: [SvgPicture.asset(item.icon ?? ''), Text(item.name ?? '')]),
                                              value: item);
                                        }),
                                        hint: Text('+65', style: TextStyle(color: Color(0xFFB4B4B4))),
                                        isDense: true,
                                        isExpanded: true,
                              ...
                              child: Container(
                                ...
                                child: DropdownButtonHideUnderline(
                                    child: DropdownButton<String>(
                                        items: List.generate(controller.months.length, (index) {
                                          var item = controller.months[index];
                                          return DropdownMenuItem(child: Text(item), value: item);
                                        }),
                                        isDense: true,
                                        isExpanded: true,
                                        hint: Text('Mon', style: TextStyle(color: Color(0xFFB4B4B4))),
