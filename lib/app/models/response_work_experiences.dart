...
//
//     final responseWorkExperiences = responseWorkExperiencesFromJson(jsonString);

import 'dart:convert';

import 'package:maiden_employer/app/models/response_standard.dart';

class ResponseWorkExperiences extends ResponseModel {
  ResponseWorkExperiences({
    this.error,
    this.data,
    this.message,
  });
  ...
  factory ResponseWorkExperiences.fromRawJson(String str) => ResponseWorkExperiences.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory ResponseWorkExperiences.fromJson(Map<String, dynamic> json) => ResponseWorkExperiences(
