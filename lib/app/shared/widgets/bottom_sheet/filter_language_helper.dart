...
class FilterLanguageHelper extends StatelessWidget {
  FilterLanguageHelper({Key? key, required this.statusBar}) : super(key: key);
            ...
            children: [
              AppBar(
                ...
                leading: IconButton(
                  onPressed: () {
                    Get.back();
                    controller.onSetLanguage(false, false);
                  },
                  icon: Icon(
                ...
                title: Text(
                  "filters_language".tr.toUpperCase(),
                ...
                actions: [
                  InkWell(
                    onTap: () {
                      controller.onSetLanguage(false, true);
                    },
                    child: Align(
                      alignment: Alignment.center,
                      child: Text(
                        (controller.isAllLanguageSelected.value) ? "clear".tr.toUpperCase() : "all".tr.toUpperCase(),
                        textAlign: TextAlign.center,
                        style: TextStyle(
                          fontFamily: AppConstant.SF_PRO_FONT,
                          color: Colors.white,
              ...
              Expanded(
                child: ListView.separated(
                  ...
                  itemCount: controller.helpersLanguage.length,
                  itemBuilder: (context, index) {
                    OptionLanguageHelpersModel item = controller.helpersLanguage[index];
                    return InkWell(
                      onTap: () {
              ...
              Container(
                ...
                child: ButtonFill(
                  onPressed: () {
                    Get.back();
                    controller.onSetLanguage(true, false);
                  },
