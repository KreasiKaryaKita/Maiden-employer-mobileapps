...
class FilterEducationHelper extends StatelessWidget {
  FilterEducationHelper({Key? key, required this.statusBar}) : super(key: key);
            ...
            children: [
              AppBar(
                ...
                leading: IconButton(
                  onPressed: () {
                    Get.back();
                    controller.onSetEducation(false, false);
                  },
                  icon: Icon(
                ...
                title: Text(
                  "filters_education".tr.toUpperCase(),
                ...
                actions: [
                  InkWell(
                    onTap: () {
                      controller.onSetEducation(false, true);
                    },
                    child: Align(
                      alignment: Alignment.center,
                      child: Text(
                        (controller.isAllEducationSelected.value) ? "clear".tr.toUpperCase() : "all".tr.toUpperCase(),
                        textAlign: TextAlign.center,
                        style: TextStyle(
                          fontFamily: AppConstant.SF_PRO_FONT,
                          color: Colors.white,
              ...
              Expanded(
                child: ListView.separated(
                  ...
                  itemCount: controller.helpersEducation.length,
                  itemBuilder: (context, index) {
                    OptionEducationHelpersModel item = controller.helpersEducation[index];
                    return InkWell(
                      onTap: () {
                        controller.onSelectEducation(index);
                      },
                      child: Row(
                        children: [
                          Expanded(
              ...
              Container(
                ...
                child: ButtonFill(
                  onPressed: () {
                    Get.back();
                    controller.onSetEducation(true, false);
                  },
